...
// Risk score weights — based on clinical endometriosis risk factors
const RISK_WEIGHTS = {
  avgPainMultiplier: 6, // avg pain (0-10) contributes up to 60 points
  highPainRatioMax: 20, // high-pain entry ratio contributes up to 20 points
  surgeryPenalty: 15, // prior surgery increases risk
  noHormonePenalty: 10, // absence of hormonal treatment increases risk
  noImagingPenalty: 5, // lack of recent imaging increases risk
} as const
...
export const PatientDetailPage: React.FC = () => {
  ...
  const chartData = React.useMemo(
    ...
    [entries, dateFnsLocale]
  )

  const prognosis = React.useMemo(() => computePrognosis(entries), [entries])
